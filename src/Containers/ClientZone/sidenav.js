  ...
  render() {
    return (
      <Nav vertical className="navContainer">
        <NavItem style={{}}>
          <NavLink href={"/clientzone/" + this.props.id}  className="myNav">
            {" "}
        ...
        <NavItem style={{}}>
        <NavLink href={"/clientzone/payments/" + this.props.id}  className="myNav">
            {" "}
            <i className="fas fa-credit-card p5" style={{}} /> <span> Payments</span>{" "}
          </NavLink>
        </NavItem>
        <NavItem style={{}}>
          <NavLink href={"/clientzone/invoices/"+ this.props.id} className="myNav">
            {" "}
            <i className="fas fa-magic p5" style={{}} /> <span> Invoices</span>{" "}
          </NavLink>
        </NavItem>
        <NavItem style={{}}>
          <NavLink href={"/clientzone/quotes/"+ this.props.id} className="myNav">
            {" "}
            <i className="fas fa-list p5" style={{}} /> <span> Quotes</span>{" "}
          </NavLink>
        </NavItem>
        <NavItem style={{}}>
          <NavLink href={"/clientzone/support/"+ this.props.id } className="myNav">
            {" "}
