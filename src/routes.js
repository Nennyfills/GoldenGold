...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', component: Dashboard },
    ...
    { path: '/admin/clients/CreateQuote/:id',  exact:true,  name: 'Client', component: ClientCreateQuote },
    { path: '/admin/clients/invoices/list/:id',  exact:true,  name: 'Client', component: ClientInvoice },
    { path: '/admin/clients/payments/list/:id',  exact:true,  name: 'Client', component: ClientPayments },
    { path: '/admin/clients/tickets/list/:id',  exact:true,  name: 'Tickets', component: ClientTickets },
    { path: '/admin/clients/documents/list/:id',  exact:true,  name: 'Refunds', component: ClientDocs },
    { path: '/admin/clients/refunds/list/:id',  exact:true,  name: 'refunds', component: ClientRefunds },
    { path: '/admin/clients/accounts/list/:id',  exact:true,  name: 'accounts', component: ClientAccounts },
    { path: '/admin/clients/edit/:id',  name: 'Edit', component: EditClient },
    { path: '/admin/:uid/quote/:id',  exact:true,  name: 'Client', component: ClientSingleQuote },
    { path: '/admin/:uid/payment/:id',  exact:true,  name: 'Client', component: ClientSinglePayment },

    { path: '/admin/:uid/invoice/:id',  exact:true,  name: 'Client', component: ClientSingleInvoice },
    { path: '/admin/clients/:id',  name: 'Client', component: Client },
    { path: '/admin/billing', exact:true, name: 'Billing', component: Billing },
    { path: '/admin/billing/quotes', exact:true, name: 'Billing', component: BillingsQuotes },
    { path: '/admin/billing/invoices', exact:true, name: 'Billing', component: Billing },
    { path: '/admin/billing/payments', exact:true, name: 'Billing', component: BillingsPayments },
    { path: '/admin/billing/refunds', exact:true, name: 'Billing', component: BillingsRefunds },
    { path: '/admin/system', exact:true, name: 'System', component: SystemProduct },
    { path: '/admin/system/products/',  exact:true,  name: 'Products', component: SystemProducts },
    { path: '/admin/system/products/create', exact:true, name: 'Products', component: SystemProductsCreate },
    { path: '/admin/system/products/:id',  exact:true,  name: 'Products', component: SystemProduct },
    { path: '/admin/system/services', exact:true, name: 'Services', component: SystemServices },
    { path: '/admin/system/services/create', exact:true, name: 'Services', component: SystemServicesCreate },
    { path: '/admin/system/services/:id', exact:true, name: 'Services', component: SystemService },
    ,
    {
      path: "/admin/sites",
      exact: true,
